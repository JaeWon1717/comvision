...
/*                                                                           */
/* 문제 정의 :영상 디졸브 ,뺄셈연산,논리연산등을 통해
두 사진의 차이점이나 공통점을 부각하여 보는 실험.* /
/*                - - - - - - -                                            */
/*******************************************************/
#include <opencv.hpp>
...
void main() {
	Mat image1 = imread("C:/my_images/Fig0228(a)(angiography_mask_image).tif",0);
	Mat image2 = imread("C:/my_images/Fig0228(b)(angiography_live_ image).tif",0);
